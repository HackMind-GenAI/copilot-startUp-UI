          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-blue-800 font-semibold">{deal.exit_strategy.timeline}</p>
                <p className="text-blue-600 text-sm">{deal.exit_strategy.timeline_description}</p>
              </div>
            </div>
            <div>
              <h4 className="font-semibold text-navy mb-3">Potential Exit Valuation</h4>
              <div className="bg-gold bg-opacity-20 p-4 rounded-lg">
                <p className="text-navy font-bold text-xl">{deal.exit_strategy.potential_valuation}</p>
                <p className="text-gray-600 text-sm">{deal.exit_strategy.valuation_description}</p>
              </div>
            </div>
            <div>
              <h4 className="font-semibold text-navy mb-3">Exit Strategies</h4>
              <ul className="space-y-2 text-gray-600">
                {deal.exit_strategy.exit_options.map((option, index) => (
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-3">
                {deal.exit_strategy.strategic_acquirers.map((acquirer, index) => (
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between py-2 border-b border-gray-200">
                  ...
                  <span className="font-semibold text-navy">{deal.exit_strategy.market_multiples.revenue_multiple}</span>
                </div>
                <div className="flex justify-between py-2 border-b border-gray-200">
                  <span className="text-gray-600">Growth Premium</span>
                  <span className="font-semibold text-green-600">{deal.exit_strategy.market_multiples.growth_premium}</span>
                </div>
                <div className="flex justify-between py-2 border-b border-gray-200">
                  <span className="text-gray-600">Recent Comparables</span>
                  <span className="font-semibold text-blue-600 text-xs">{deal.exit_strategy.market_multiples.recent_comparables}</span>
                </div>
