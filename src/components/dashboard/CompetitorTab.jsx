        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <div className="space-y-4">
              {deal.competitors?.direct_competitors?.map((competitor, index) => (
            ...
            <div className="space-y-4">
              <div className="p-4 bg-green-50 rounded-lg">
                ...
                <ul className="text-sm text-green-700 space-y-1">
                  {deal.competitors?.analysis?.advantages?.map((advantage, index) => (
              ...
              <div className="p-4 bg-red-50 rounded-lg">
                ...
                <ul className="text-sm text-red-700 space-y-1">
                  {deal.competitors?.analysis?.challenges?.map((challenge, index) => (
          ...
          <div className="glass-card p-6 rounded-2xl">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-blue-50 rounded-lg">
                ...
                <p className="text-blue-600 text-xs">{deal.competitors?.analysis?.competitive_strategy?.differentiation_focus}</p>
              </div>
              <div className="p-3 bg-green-50 rounded-lg">
                <p className="text-green-800 font-semibold text-sm">Cost Leadership</p>
                <p className="text-green-600 text-xs">{deal.competitors?.analysis?.competitive_strategy?.cost_leadership}</p>
              </div>
              <div className="p-3 bg-purple-50 rounded-lg">
                <p className="text-purple-800 font-semibold text-sm">Innovation Edge</p>
                <p className="text-purple-600 text-xs">{deal.competitors?.analysis?.competitive_strategy?.innovation_edge}</p>
              </div>
            </div>
          </div>
          <div className="glass-card p-6 rounded-2xl">
